...
contract AggregatorProxy is AggregatorV2V3Interface, Owned {
    ...
    returns (uint256 roundId)
  {
    ...
    return encodeRoundId(phase.id, uint64(phase.aggregator.latestRound()));
  }
  ...
  */
  ...
  {
    return (
      encodeRoundId(_phaseId, uint64(roundId)),
      answer,
      startedAt,
      updatedAt,
      encodeRoundId(_phaseId, uint64(answeredInRound))
    );
  }
