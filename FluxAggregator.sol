...
contract FluxAggregator is AggregatorV2V3Interface, Owned {
  ...
  AutumnTokenInterface public linkToken;
   ...
   * reserve of RESERVE_ROUNDS * oracleCount() ATM earmarked for payment to
   ...
   * @param _paymentAmount The amount paid of ATM paid to each oracle per submission, in wei (units of 10⁻¹⁸ ATM)
  ...
  constructor(
    ...
    linkToken = AutumnTokenInterface(_atm);
  ...
  /**
   * @notice recalculate the amount of ATM available for payouts
   */
  ...
  /**
   * @notice query the available amount of ATM for an oracle to withdraw
   */
  ...
  /**
   * @notice transfers the oracle's ATM to another address. Can only be called
   * by the oracle's admin.
   * @param _oracle is the oracle whose ATM is transferred
   * @param _recipient is the address to send the ATM to
   * @param _amount is the amount of ATM to send
   */
    ...
    external
  {
    ...
    // Safe to downcast _amount because the total amount of ATM is less than 2^128.
  ...
  /**
   * @notice transfers the owner's ATM to another address
   * @param _recipient is the address to send the ATM to
   * @param _amount is the amount of ATM to send
   */
  ...
  /**
   * @notice called through ATM's transferAndCall to update available funds
